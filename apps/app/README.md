# ![Modrinthium](/.github/assets/app_cover.png)

## Modrinthium

Modrinthium is a desktop application for managing your Minecraft mods. It is built with [Tauri](https://tauri.app/) and [Vue](https://vuejs.org/).
