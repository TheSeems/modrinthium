...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	{
		...
		whatHappened:
			'Your saved Microsoft sign-in token has expired or was revoked, so Modrinthium cannot refresh your Minecraft session.',
		stepsToFix: [
			'Sign out of the affected Minecraft account in Modrinthium',
	...
	},
	{
		...
		stepsToFix: [
			...
			'Restart Modrinthium after waiting',
	...
	},
	{
		...
		whatHappened:
			"Minecraft's authentication service is returning a server error, so Modrinthium cannot finish signing you in right now.",
		stepsToFix: [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Try signing in to Modrinthium again',
		],
	},
	{
		matches: (message) =>
		...
		whatHappened:
			'Modrinthium could not connect to a Microsoft, Xbox, or Minecraft service needed for sign-in. This is usually caused by a local network, DNS, proxy, firewall, hosts file, VPN, or antivirus issue.',
		stepsToFix: [
			'Restart Modrinthium and try signing in again',
			'Check that your internet connection is working',
			'Allow Modrinthium through your firewall, antivirus, proxy, VPN, and hosts file rules',
	...
	},
	{
		...
		whatHappened:
			'Xbox services rejected the request to authorize this account for Minecraft services, but did not return a specific account restriction that Modrinthium recognizes.',
		stepsToFix: [
			'Sign in with the <a href="https://www.minecraft.net/en-us/download">official Minecraft Launcher</a>',
