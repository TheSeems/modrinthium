...
import SeedInstallModal from '@/components/ui/SeedInstallModal.vue'
...
const sidebarVisible = computed(() => false)
...
const tauriApiClient = new TauriModrinthClient({
	userAgent: async () => `modrinthium/${await appVersion}`,
...
const updatePopupMessages = defineMessages({
	...
	meteredBody: {
		...
		defaultMessage: `Modrinthium v{version} is available now! Since you're on a metered network, we didn't automatically download it.`,
	},
	downloadedBody: {
		id: 'app.update-popup.body.download-complete',
		defaultMessage: `Modrinthium v{version} has finished downloading. Reload to update now, or automatically when you close Modrinthium.`,
	},
	linuxBody: {
		id: 'app.update-popup.body.linux',
		defaultMessage:
			'Modrinthium v{version} is available. Use your package manager to update for the latest features and fixes!',
	},
	reload: {
...
<template>
	...
	>
		...
		<CreationFlowModal
			...
			@seed-install="seedInstallModal?.show()"
		/>
		<UnknownPackWarningModal ref="unknownPackWarningModal" />
		<SeedInstallModal ref="seedInstallModal" />
		<div
		...
		<div data-tauri-drag-region class="app-grid-statusbar bg-bg-raised h-[--top-bar-height] flex">
			...
			<section data-tauri-drag-region class="flex shrink-0 ml-auto items-center gap-3">
				<Suspense>
	...
	>
		...
		>
			<div class="app-sidebar-scrollable flex-grow shrink relative overflow-y-auto">
...
.app-contents {
	...
	// Only reserve the right column when a page has teleported sidebar content
	// into #sidebar-teleport-target; otherwise it collapses to full-width content.
	&:has(#sidebar-teleport-target > *) {
